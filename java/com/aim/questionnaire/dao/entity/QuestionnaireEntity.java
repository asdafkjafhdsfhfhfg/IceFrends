...
public class QuestionnaireEntity {
    ...
    private List<AnswerEntity> sendInfo;

    public List<AnswerEntity> getSendInfo() {
        return sendInfo;
    }

    public void setSendInfo(List<AnswerEntity> sendInfo) {
    ...
    public void setQuestionName(String questionName) {
        this.questionId = questionName == null ? null : questionName.trim();
    }
